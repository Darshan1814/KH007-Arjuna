...
const testimonials = [
  { name: 'Priya S.', uni: 'CMU → $185K', text: 'EduFinAI\'s admission predictor was spot-on. Got into my dream university with the exact profile it recommended!', avatar: '👩‍💻' },
  { name: 'Arjun M.', uni: 'Georgia Tech → $140K', text: 'The ROI calculator convinced my parents. They could see the exact breakeven point. Got an Auxilo loan in 10 days.', avatar: '👨‍🎓' },
  { name: 'Sneha R.', uni: 'UofT → CAD $95K', text: 'The SOP Co-Pilot saved me weeks. It took my bullet points and crafted a narrative that got me 3 admits!', avatar: '👩‍🔬' },
]
      ...
      <section ref={heroRef} className="relative min-h-screen flex items-center justify-center pt-20 bg-grid">
        ...
        <motion.div style={{ opacity, y }} className="relative z-10 max-w-5xl mx-auto px-4 text-center">
          ...
          <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.6 }}
            ...
            From university shortlisting to visa prep to education loans — EduFinAI replaces
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}
            ...
            <p className="max-w-xl mx-auto" style={{ color: 'var(--foreground-secondary)' }}>
              No more juggling 7 apps. EduFinAI combines AI mentoring, financial planning, and application tools.
            </p>
          </motion.div>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold" style={{ color: 'var(--foreground-secondary)' }}>EduFinAI</span>
            </div>
            <div className="text-sm">Made with ❤️ for Indian students • © 2026 EduFinAI</div>
